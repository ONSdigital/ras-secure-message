...
class Modifier:
    ...
    def replace_current_draft(draft_id, draft):
        ...
        save_new_draft = "INSERT INTO secure_message (msg_id, subject, body, thread_id, " \
                         ...
                         "'{1}', '{2}', '{3}', '{4}', '{5}', '{6}','{7}', '{8}')"\
                         .format(draft_id, draft.subject, draft.body, draft.thread_id, draft.reporting_unit,
                                 draft.collection_exercise, draft.survey, draft.business_name, draft.collection_case)
