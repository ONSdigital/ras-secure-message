...
NOTIFICATION_SERVICE_ID = os.getenv('SERVICE_ID', 'SETME')
NOTIFICATION_API_KEY = os.getenv('NOTIFICATION_API_KEY', 'SETME')
NOTIFICATION_COMBINED_KEY = 'key-name-{}-{}'.format(NOTIFICATION_SERVICE_ID, NOTIFICATION_API_KEY)
NOTIFICATION_API_KEY = os.getenv('NOTIFICATION_TEMPLATE_ID', 'SETME')
