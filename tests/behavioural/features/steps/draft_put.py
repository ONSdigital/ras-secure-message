...
# Scenario 3: A user edits a previously saved draft without formatting
...
# Scenario 4: A user edits a previously saved draft without formatting and msg_to
...
# Scenario 5: A user edits a draft that has not been previously saved
...
# Scenario 6: A user edits a draft that has a too large to attribute
...
# Scenario 7: A user edits a draft that has a too large from attribute
...
# Scenario 8: A user edits a draft that has a too large body attribute
...
# Scenario 9: A user edits a draft that has a too large subject attribute
...
# Scenario 10: A user edits a draft not including a to attribute
...
# Scenario 11: A user edits a draft not including a body attribute
...
# Scenario 12: A user edits a draft not including a subject attribute
...
# Scenario 13: A user edits a draft not including a thread id attribute
...
# Scenario 14: A user edits a draft where msg id in url and in the message body do not match
...
# Scenario 15: A user is editing a draft while another user tries to modify the same draft
