...
@given("the collection case is too long")
...
@then("retrieved message collection case is as was saved")
...
@given("collection case is set to alternate collection case")
@when("collection case is set to alternate collection case")
...
@given("collection case set to default collection case")
