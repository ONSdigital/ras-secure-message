...
class TestClientTokenFunctions(unittest.TestCase):
    ...
    def test_set_expiry_on_startup(self):
        ...
        with self.app.app_context():
            self.assertAlmostEqual(self.app.oauth_client_token_expires_at, maya.now(), delta=timedelta(seconds=1))
    ...
    def test_get_client_token(self):
        ...
        with self.app.app_context():
            resp = get_client_token("test_id", "test_secret", "http://test")
    ...
    def test_get_client_token_http_error_400_range(self):
        ...
        with self.assertRaises(SystemExit):
            get_client_token("test_id", "test_secret", "http://test")
