...
def get_args(page=1, limit=100, surveys=None, cc="", ru="", label="", desc=True, ce="", is_closed=False,
             my_conversations=False, new_respondent_conversations=False, all_conversation_types=False, unread_conversations=False):
...
class UtilitiesTestCase(unittest.TestCase):
    ...
    internal_user_record = {'id': '01b51fcc-ed43-4cdb-ad1c-450f9986859b', 'firstName': 'fred', 'lastName': 'flinstone',
                            'emailAddress': 'mock@email.com'}

    external_user_record = {"id": "0a7ad740-10d5-4ecb-b7ca-3c0384afb882", "firstName": "Vana", "lastName": "Oorschot",
                            "emailAddress": "vana123@aol.com", "telephone": "+443069990289", "status": "ACTIVE",
                            "sampleUnitType": "BI"}
    ...
    def test_get_business_details_with_external_message_first(self):
        ...
        populated_message = [{'body': 'Reply body from respondent', 'case_id': '', 'exercise_id': '',
                              'from_internal': False,
                              ...
                              'read_date': '2018-06-05 15:23:39.898317',
                              'business_id': 'f1a5e99c-8edf-489a-9c72-6cabe6c387fc',
                              'sent_date': '2018-06-05 15:23:38.025084', 'subject': 'Message to ONS',
                              'survey_id': 'cb8accda-6118-4d3b-85a3-149e28960c54',
                              'thread_id': '53a430f1-de21-4279-b17e-1bfb4c4813a6',
                              '@business_details': {'id': 'f1a5e99c-8edf-489a-9c72-6cabe6c387fc', 'name': 'Apple'}},
                             {'body': 'Reply body from internal user', 'case_id': '', 'exercise_id': '',
                              'from_internal': True,
    ...
    def test_get_business_details_with_internal_message_first(self):
        ...
        populated_message = [{'body': 'Reply body from internal user', 'case_id': '', 'exercise_id': '',
                              'from_internal': True,
                              'labels': ['INBOX'], 'msg_from': '01b51fcc-ed43-4cdb-ad1c-450f9986859b',
                              'msg_id': '048ffdb5-18f0-46f0-bfa0-ea298521c513',
                              'msg_to': ['0a7ad740-10d5-4ecb-b7ca-3c0384afb882'],
                              ...
                              'thread_id': '53a430f1-de21-4279-b17e-1bfb4c4813a6',
                              '@business_details': {'id': 'f1a5e99c-8edf-489a-9c72-6cabe6c387fc', 'name': 'Apple'}},
                             {'body': 'Reply body from respondent', 'case_id': '', 'exercise_id': '',
                              'from_internal': False,
                              'labels': ['INBOX'], 'msg_from': '0a7ad740-10d5-4ecb-b7ca-3c0384afb882',
                              'msg_id': '048ffdb5-18f0-46f0-bfa0-ea298521c513',
                              'msg_to': ['01b51fcc-ed43-4cdb-ad1c-450f9986859b'],
    ...
    def test_add_from_details_with_external_message_first(self):
        ...
        populated_message = [{'body': 'Reply body from respondent', 'case_id': '', 'exercise_id': '',
                              ...
                              'survey_id': 'cb8accda-6118-4d3b-85a3-149e28960c54',
                              'thread_id': '53a430f1-de21-4279-b17e-1bfb4c4813a6',
                              '@msg_from': {'id': '0a7ad740-10d5-4ecb-b7ca-3c0384afb882', 'firstName': 'Vana',
                                            'lastName': 'Oorschot',
    ...
    def test_add_to_details_with_external_message_first(self):
        ...
        populated_message = [{'body': 'Reply body from respondent', 'case_id': '', 'exercise_id': '',
                             ...
                             {'body': 'Reply body from internal user', 'case_id': '', 'exercise_id': '',
                              ...
                              'survey_id': 'cb8accda-6118-4d3b-85a3-149e28960c54',
                              'thread_id': '53a430f1-de21-4279-b17e-1bfb4c4813a6',
                              '@msg_to': [{'id': '0a7ad740-10d5-4ecb-b7ca-3c0384afb882', 'firstName': 'Vana',
                                           'lastName': 'Oorschot',
                                           'emailAddress': 'vana123@aol.com', 'telephone': '+443069990289',
                                           'status': 'ACTIVE', 'sampleUnitType': 'BI'}]}]
