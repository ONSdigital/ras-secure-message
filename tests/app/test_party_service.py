...
class PartyTestCase(unittest.TestCase):
    ...
    @requests_mock.mock()
    def test_get_user_details_for_group_user(self, mock_request):
        """Test get user details sends a request and receives back data"""
        sut = PartyService()
        user_data_url = f"{self.app.config['RAS_PARTY_SERVICE']}party-api/v1/respondents/id/{constants.NON_SPECIFIC_INTERNAL_USER}"
