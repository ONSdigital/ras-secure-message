...
### Status 
message dependent, it records basic information regarding who’s inbox it is in and the state of the message (read, sent etc). Similar to secure message a record is kept if it has not been read, but it gets deleted once it has
