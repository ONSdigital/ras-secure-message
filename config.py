...
class Config:
    ...
    VERSION = os.getenv('VERSION', '0.11.0')
    ...
    FRONTSTAGE_SERVICE_HOST = os.getenv('RAS_FRONTSTAGE_HOST', 'localhost')
    FRONTSTAGE_SERVICE_PORT = os.getenv('RAS_FRONTSTAGE_PORT', 8082)
    RAS_FRONTSTAGE_SERVICE = f'http://{FRONTSTAGE_SERVICE_HOST}:{FRONTSTAGE_SERVICE_PORT}/'
