...
class ThreadById(Resource):
    ...
    def get(thread_id):
        ...
        conversation = message_service.retrieve_thread(thread_id, g.user, message_args.page, message_args.limit)
...
class ThreadList(Resource):
    ...
    def get():
        ...
        message_service = Retriever()
        result = message_service.retrieve_thread_list(message_args.page, message_args.limit, g.user)
