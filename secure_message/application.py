...
def create_app(config=None):
    ...
    api.add_resource(MessageSend, '/messages/send')
    api.add_resource(MessageById, '/messages/<message_id>')
    api.add_resource(MessageModifyById, '/messages/<message_id>/modify')
    api.add_resource(DraftSave, '/drafts/save')
    api.add_resource(DraftModifyById, '/drafts/<draft_id>/modify')
    api.add_resource(DraftById, '/drafts/<draft_id>')
